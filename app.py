...
# --- CONFIGURAZIONE TICKERS (Yahoo Finance - Solo Azionari Sviluppati, AGGH rimosso) ---
ETF_CONFIG = {
...
if best_dist_sma < 0:
    depth_factor = min(abs(best_dist_sma) / 4.0, 1.0)
    ...
    over_penalty = min(best_dist_sma / 3.0, 1.0)
