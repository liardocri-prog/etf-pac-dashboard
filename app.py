...
with col_title:
    ...
    st.write("Calcolatore dell'importo esatto in **Euro** da investire per ciascun ETF. Clicca su un titolo per aprire la scheda nel **pop-up scuro**.")
...
st.caption("Source: Simulated market data · Developed Markets PAC Screener | QuantEdge v2.9")