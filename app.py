...
# 2. CSS Personalizzato Corretto (Bottoni Dark & Modali BaseWeb)
st.markdown("""
<style>
    /* Sfondo Generale */
    .stApp {
    ...
    /* Eliminazione sfondo bianco dai bottoni Streamlit e stile Dark personalizzato */
    .stButton > button {
        background-color: #131822 !important;
        color: #00e676 !important;
        border: 1px solid #1e293b !important;
...
with col_title:
    ...
    st.write("Acquisto mensile concentrato **sull'ETF più conveniente** (maggiore sconto / drawdown). Clicca sul pulsante dell'ETF per aprire il pop-up scuro.")
...
st.caption("Source: Simulated market data · Developed Markets PAC Screener | QuantEdge v3.2")